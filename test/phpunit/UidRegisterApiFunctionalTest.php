...
/**
 * \file    test/phpunit/UidRegisterApiFunctionalTest.php
...
/**
 * Class UidRegisterApiFunctionalTest
 *
 ...
 *
 * @package Testuidregisterapi
 */
class UidRegisterApiFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUidRegisterApi')->click();
		} else {
			// Disable the module
			$this->byHref('modUidRegisterApi')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/uidregisterapi/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('uidregisterapi/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/uidregisterapi/admin/about.php');
		$this->authenticate();
		return $this->assertContains('uidregisterapi/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('uidregisterapiwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modUidRegisterApi_UidRegisterApiTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUidRegisterApi_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
